...
class _HodDashboardState extends State<HodDashboard> {
  ...
  final List<Map<String, dynamic>> allSubmissions = List.generate(15, (index) {
    ...
    return {
      ...
      'reviewer': 'Reviewer ${String.fromCharCode(65 + index)}',
  ...
  void _onAccept(String document) {
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Accepted $document')));
  }
  ...
  void _navigateTo(String page) {
    if (page == 'Student') {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const ReviewerPage()),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Head of Department (HOD) Review Page'),
